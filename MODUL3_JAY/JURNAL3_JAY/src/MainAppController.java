...
public class MainAppController {
    ...
    private void deleteTask() {
        try {
            ...
            if (selected == null) {
                ...
                throw new TaskNotSelectedException("Tidak ada Data yang terpilih");
            }
    ...
    private void markTaskComplete() {
        try {
            ...
            if (selected == null) {
                // TODO: Throw new TaskNotSelectedException dengan pesan yang sesuai
                throw new TaskNotSelectedException("Tugas Telah Selesai Aduhai Uhuy");
            }
